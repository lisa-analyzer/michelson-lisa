...
public class MichelsonFailwith extends NaryExpression {

	public MichelsonFailwith(CFG cfg, String sourceFile, int line, int col) {
		super(cfg, new SourceCodeLocation(sourceFile, line, col), "FAILWITH");
	}
