...
public class MichelsonKeccak extends UnaryExpression implements StackConsumer, StackProducer {

	public MichelsonKeccak(CFG cfg, String sourceFile, int line, int col, Expression expression) {
		super(cfg, new SourceCodeLocation(sourceFile, line, col), "KECCAK", MichelsonBytesType.INSTANCE, expression);
