...
public class MichelsonOpen_chest extends NaryExpression {

	public MichelsonOpen_chest(CFG cfg, String sourceFile, int line, int col) {
		super(cfg, new SourceCodeLocation(sourceFile, line, col), "OPEN_CHEST");
	}
