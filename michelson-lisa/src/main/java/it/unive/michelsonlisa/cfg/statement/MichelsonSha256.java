...
public class MichelsonSha256 extends UnaryExpression implements StackConsumer, StackProducer {

	public MichelsonSha256(CFG cfg, String sourceFile, int line, int col, Expression expression) {
		super(cfg, new SourceCodeLocation(sourceFile, line, col), "SHA256", MichelsonBytesType.INSTANCE, expression);
