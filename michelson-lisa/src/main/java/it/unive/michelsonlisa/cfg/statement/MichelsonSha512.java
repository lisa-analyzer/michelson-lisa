...
public class MichelsonSha512 extends UnaryExpression implements StackConsumer, StackProducer {

	public MichelsonSha512(CFG cfg, String sourceFile, int line, int col, Expression expression) {
		super(cfg, new SourceCodeLocation(sourceFile, line, col), "SHA512", MichelsonBytesType.INSTANCE, expression);
