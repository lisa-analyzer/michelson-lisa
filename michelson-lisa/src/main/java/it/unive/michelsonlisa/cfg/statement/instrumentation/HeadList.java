...
public class HeadList extends BinaryExpression implements StackProducer, StackConsumer {

	public HeadList(CFG cfg, SourceCodeLocation srcLoc, VariableRef left, VariableRef right) {
		super(cfg, srcLoc, "HeadList", left, right);
	}
