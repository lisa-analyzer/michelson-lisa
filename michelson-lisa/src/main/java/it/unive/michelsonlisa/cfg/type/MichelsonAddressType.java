...
/**
 * Boolean type of Michelson language. This is the only address type available for Michelson. It
 ...
 * {@link MichelsonAddressType#INSTANCE}.
 * 
 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
 */
public class MichelsonAddressType implements MichelsonType, MichelsonComparableType, MichelsonPassableType, MichelsonStorableType, MichelsonPushableType, MichelsonPackableType, MichelsonBigMapValueType, MichelsonDuplicableType {

	/**
	 * Unique instance of MichelsonAddressType.
	 */
	public static final MichelsonAddressType INSTANCE = new MichelsonAddressType();

	private MichelsonAddressType() {
	}
	...
	public boolean canBeAssignedTo(Type other) {
		return other instanceof MichelsonAddressType || other.isUntyped();
	}

	@Override
	public Type commonSupertype(Type other) {
		return other instanceof MichelsonAddressType ? this : Untyped.INSTANCE;
	}
