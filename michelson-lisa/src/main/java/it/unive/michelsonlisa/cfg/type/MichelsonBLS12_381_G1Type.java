...
/**
 * BLS12_381_G1_TYPE type of Michelson language. This is the only BLS12_381_G1_TYPE type available for Michelson. It
 ...
 * {@link MichelsonBLS12_381_G1Type#INSTANCE}.
 * 
 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
 */
public class MichelsonBLS12_381_G1Type implements MichelsonType, MichelsonPassableType, MichelsonStorableType, MichelsonPushableType, MichelsonPackableType, MichelsonBigMapValueType, MichelsonDuplicableType {

	/**
	 * Unique instance of MichelsonBLS12_381_G1Type.
	 */
	public static final MichelsonBLS12_381_G1Type INSTANCE = new MichelsonBLS12_381_G1Type();

	private MichelsonBLS12_381_G1Type() {
	}

	@Override
	public String toString() {
		return "BLS12_381_G1_TYPE";
	}
	...
	public boolean canBeAssignedTo(Type other) {
		return other instanceof MichelsonBLS12_381_G1Type || other.isUntyped();
	}

	@Override
	public Type commonSupertype(Type other) {
		return other instanceof MichelsonBLS12_381_G1Type ? this : Untyped.INSTANCE;
	}
