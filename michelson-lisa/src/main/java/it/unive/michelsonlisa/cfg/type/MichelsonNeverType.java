...
/**
 * Boolean type of Michelson language. This is the only never type available for Michelson. It
 ...
 * {@link MichelsonNeverType#INSTANCE}.
 * 
 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
 */
public class MichelsonNeverType implements MichelsonType, MichelsonComparableType, MichelsonPassableType, MichelsonStorableType, MichelsonPushableType, MichelsonPackableType, MichelsonBigMapValueType, MichelsonDuplicableType {

	/**
	 * Unique instance of MichelsonNeverType.
	 */
	public static final MichelsonNeverType INSTANCE = new MichelsonNeverType();

	private MichelsonNeverType() {
	}
	...
	public boolean canBeAssignedTo(Type other) {
		return other instanceof MichelsonNeverType || other.isUntyped();
	}

	@Override
	public Type commonSupertype(Type other) {
		return other instanceof MichelsonNeverType ? this : Untyped.INSTANCE;
	}
