...
/**
 * Boolean type of Michelson language. This is the only signature type available for Michelson. It
 ...
 * {@link MichelsonSignatureType#INSTANCE}.
 * 
 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
 */
public class MichelsonSignatureType implements MichelsonType, MichelsonComparableType, MichelsonPassableType, MichelsonStorableType, MichelsonPushableType, MichelsonPackableType, MichelsonBigMapValueType, MichelsonDuplicableType {

	/**
	 * Unique instance of MichelsonSignatureType.
	 */
	public static final MichelsonSignatureType INSTANCE = new MichelsonSignatureType();

	private MichelsonSignatureType() {
	}
	...
	public boolean canBeAssignedTo(Type other) {
		return other instanceof MichelsonSignatureType || other.isUntyped();
	}

	@Override
	public Type commonSupertype(Type other) {
		return other instanceof MichelsonSignatureType ? this : Untyped.INSTANCE;
	}
