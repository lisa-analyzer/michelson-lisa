...
/**
 * Boolean type of Michelson language. This is the only timestamp type available for Michelson. It
 ...
 * {@link MichelsonTimestampType#INSTANCE}.
 * 
 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
 */
public class MichelsonTimestampType implements MichelsonType, MichelsonComparableType, MichelsonPassableType, MichelsonStorableType, MichelsonPushableType, MichelsonPackableType, MichelsonBigMapValueType, MichelsonDuplicableType {

	/**
	 * Unique instance of MichelsonTimestampType.
	 */
	public static final MichelsonTimestampType INSTANCE = new MichelsonTimestampType();

	private MichelsonTimestampType() {
	}
	...
	public boolean canBeAssignedTo(Type other) {
		return other instanceof MichelsonTimestampType || other.isUntyped();
	}

	@Override
	public Type commonSupertype(Type other) {
		return other instanceof MichelsonTimestampType ? this : Untyped.INSTANCE;
	}
