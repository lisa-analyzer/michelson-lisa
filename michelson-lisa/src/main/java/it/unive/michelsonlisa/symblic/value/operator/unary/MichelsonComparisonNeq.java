 ...
 */
public class MichelsonComparisonNeq implements ComparisonOperator, UnaryOperator {

	/**
	 * The singleton instance of this class.
	 */
	public static final MichelsonComparisonNeq INSTANCE = new MichelsonComparisonNeq();

	private MichelsonComparisonNeq() {
	}
	...
	public ComparisonOperator opposite() {
		return MichelsonComparisonEq.INSTANCE;
	}
