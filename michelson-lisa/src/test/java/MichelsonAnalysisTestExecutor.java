...
public abstract class MichelsonAnalysisTestExecutor {

	protected static final String EXPECTED_RESULTS_DIR = "michelson-testcases";
	protected static final String ACTUAL_RESULTS_DIR = "michelson-outputs";
	...
	private void performAux(String folder, String subfolder, String source, LiSAConfiguration configuration) {
		...
		try {
			program = MichelsonFrontEnd.processFile(target.toString());
		} catch (IOException e) {
